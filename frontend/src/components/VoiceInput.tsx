...
export const VoiceInput: React.FC<VoiceInputProps> = ({ onSendMessage, disabled = false }) => {
  ...
  useEffect(() => {
    // Feature detection for Web Speech API across browsers
      ...
      <div className="flex items-center gap-2.5">
        ...
        {isListening && (
          <div className="flex items-center gap-1 h-6 px-2.5 bg-[#FEE2E2] rounded-[6px] border border-[#DC2626]/20" aria-hidden="true">
            <div className="w-1 bg-[#DC2626] h-4 rounded-full voice-bar" />
            <div className="w-1 bg-[#DC2626] h-2.5 rounded-full voice-bar" />
            <div className="w-1 bg-[#DC2626] h-5 rounded-full voice-bar" />
            <div className="w-1 bg-[#DC2626] h-3 rounded-full voice-bar" />
            <div className="w-1 bg-[#DC2626] h-4 rounded-full voice-bar" />
