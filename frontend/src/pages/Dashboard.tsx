...
export const Dashboard: React.FC<DashboardProps> = ({ onOpenChatWithTopic }) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-16">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white border border-[#E2E8F0] rounded-[12px] p-5 sm:p-6 shadow-[0_1px_3px_rgba(15,23,42,0.06)]">
        ...
        <div className="flex items-center gap-3 self-start sm:self-center shrink-0">
          <button
            ...
            className="touch-target flex items-center gap-2 px-5 py-2.5 rounded-[8px] bg-[#2F80ED] hover:bg-[#2563D9] text-white font-semibold text-sm shadow-sm transition active:scale-[0.98] cursor-pointer"
          >
      ...
      {/* Motivational Adherence Streak Card (No stages, clear streak days & encouraging compliment) */}
      <AdherenceStreakCard />

      {/* Interactive 5-Scenario Demo Bar */}
      <DemoScenarioBar onSelectScenario={handleScenarioSelect} isLoading={false} />

      {/* Adherence & Escalation Status Meter */}
        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-5 gap-1.5">
            {[
              ...
              { step: 4, label: '4. WhatsApp Alert', color: 'bg-[#EA580C]' },
